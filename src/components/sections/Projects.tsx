...
const Projects = () => {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      description: 'A productivity application for tracking and organizing tasks. Features include drag-and-drop functionality, priority setting, and deadline reminders.',
      image: 'https://images.pexels.com/photos/6956454/pexels-photo-6956454.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940',
